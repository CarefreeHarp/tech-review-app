...
/** Provee un conjunto pequeño de notificaciones locales para la interfaz. */
object LocalNotificationsScreenProvider {

    /** Crea grupos relativos a una referencia temporal común para mantener tiempos coherentes. */

...
/** Provee los datos locales de ejemplo para la pantalla de notificaciones. */
object LocalNotificationsProvider {

    /**
     * Genera grupos de notificaciones con tiempos relativos a una misma referencia temporal.
     *
     * @param currentTimeMillis Instante usado para calcular los tiempos de cada notificación.
     * @return Grupos de notificaciones ordenados para la interfaz.
     */
    fun notificationGroups(currentTimeMillis: Long): List<Pair<String, List<NotificationContent>>> = listOf(
        "HOY" to listOf(
    ...
    /** Selecciona un avatar local estable a partir del identificador de la notificación. */
    @DrawableRes
